//
//  OldFavoritesTableViewController.m
//  HFRplus
//
...
@implementation OldFavoritesTableViewController
...
-(void) showAll:(id)sender {
    ...
    if (self.showAll) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            [self.navigationItem.leftBarButtonItem setBackgroundImage:[ThemeColors imageFromColor:[ThemeColors tintLightColor]] forState:UIControlStateNormal barMetrics:UIBarMetricsCompact];
...
- (void)viewDidLoad {
    ...
    __weak OldFavoritesTableViewController *self_ = self;
