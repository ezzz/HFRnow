...
- (void)viewDidLoad {
    ...
    [self.loadingView addSubview:self.maintenanceView];

    self.topicsTableView.backgroundColor = [UIColor cyanColor];
    self.loadingView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.8];
    self.maintenanceView.backgroundColor = [UIColor yellowColor];
    
    self.maintenanceView.hidden = YES; // masquée par défaut
    self.loadingView.hidden = YES;
    self.topicsTableView.backgroundView = self.loadingView;
...
/*
-(void)parseSearchResult:(NSData *)contentData // From Search
{
